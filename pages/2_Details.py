...
from src.plots import (calendar_task_plot,
...
from src.filters import (date_filter,
                         ...
                         project_filter,
                         weekend_filter)
from src.utils import create_color_palette
...
def render():
    ...
    completed_tasks, remove_weekends = weekend_filter(completed_tasks, "remove weekends")
    ...
    figs.append(one_hundred_stacked_bar_plot_per_project(completed_tasks, color_palette))
