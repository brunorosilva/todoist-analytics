...
def create_app():
    ...
    col3.metric("last seven days completed tasks", len(completed_tasks.loc[(
            completed_tasks['completed_date'] >= completed_tasks['completed_date'].max() - timedelta(days=7))].drop_duplicates()))
